        ...
        <div style={{
          ...
          <div style={{
            ...
            <AttendanceCard 
              ...
              description="View and analyze staff attendance records"
              icon="📝"
              color="#0d6efd"
            ...
            <AttendanceCard 
              ...
              description="Generate monthly and custom attendance reports"
              icon="📊"
              color="#fd7e14"
...
// Attendance Card Component for main options
const AttendanceCard = ({ title, description, icon, color, actionText, onClick }) => {
  return (
    <div 
      style={{
        backgroundColor: "#ffffff",
